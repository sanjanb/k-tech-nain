 ...
 */
export function createNotificationLogEntry(eventType, dealId, recipientId, channel = NOTIFICATION_CHANNELS.EMAIL) {
  return {
    eventType,
    dealId,
    recipientId,
 ...
 */
export function isDuplicateNotification(existingLogs, eventType, dealId, recipientId) {
