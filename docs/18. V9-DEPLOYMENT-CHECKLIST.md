...
### Firebase Configuration ⚠️ (Verify Before Deploy)
...
- [ ] Try invalid UPI: `noatsign` → Error shown
- [ ] Try uploading PDF → Error shown
- [ ] Try 3MB image → Error shown
- [ ] Disable payment → Confirmation asked
- [ ] Remove payment → Data cleared
- [ ] Create new farmer account → No payment required
...
**Subject**: New Feature: Optional QR Payment for Farmers 🎉
...
- ❌ UPI validation broken
- ❌ Existing flows broken
- ❌ Security concerns
- ❌ Performance issues
...
- ❌ Friday afternoon (weekend monitoring risk)
- ❌ Monday morning (high traffic)
